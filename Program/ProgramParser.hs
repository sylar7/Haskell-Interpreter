...
action_22 (21) = happyShift action_51
...
action_37 (35) = happyShift action_56
...
action_50 (35) = happyShift action_54
...
action_54 (13) = happyShift action_58
...
action_62 (37) = happyShift action_63
...
action_65 (32) = happyShift action_17
...
happyReduction_3 ((HappyAbsSyn4  happy_var_9) `HappyStk`
	_ `HappyStk`
	_ `HappyStk`
	(HappyAbsSyn4  happy_var_6) `HappyStk`
	_ `HappyStk`
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	TokenKeyword "函数" -> cont 11;
	TokenKeyword "如果" -> cont 12;
	TokenKeyword "那么" -> cont 13;
	TokenKeyword "否则" -> cont 14;
	TokenKeyword "真" -> cont 15;
	TokenKeyword "假" -> cont 16;
	TokenKeyword "声明" -> cont 17;
	Symbol ";" -> cont 18;
